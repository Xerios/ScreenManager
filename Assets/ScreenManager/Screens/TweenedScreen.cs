...
namespace ScreenMgr {
    ...
    public class TweenedScreen : BaseScreen {
        ...
        protected override void OnAnimationIn() {
            ...
            LeanTween.delayedCall(0.5f, base.OnAnimationIn);
        }

        protected override void OnAnimationOut() {


            LeanTween.value(this.gameObject,(x)=> canvasGroup.alpha = x, 1f, 0f, 0.5f).setEase(LeanTweenType.easeOutCubic).setOnComplete(base.OnAnimationOut);
        }
    }
